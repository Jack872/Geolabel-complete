...
public class DatasetController {
    ...
    public Result getDataSet() {
        try {
            List<Dataset> datasets = datasetService.getDataSet();
            return ResultGenerator.getSuccessResult(datasets);
        } catch (Exception e) {
            e.printStackTrace();
    ...
    public Result addDataSet(@RequestBody Dataset dataset) {
        try {
            ...
            dataset.setUserId(loginUser.getSysUser().getUserid());
            boolean saved = datasetService.addDataSet(dataset);
            return ResultGenerator.getSuccessResult(saved);
        } catch (Exception e) {
            e.printStackTrace();
            return ResultGenerator.getFailResult("查询所有数据集失败：" + e.getMessage());
        }
    ...
    public Result editDataSet(@RequestBody Dataset dataset) {
        try {
            ...
            return ResultGenerator.getSuccessResult(succeed);
        } catch (Exception e) {
            e.printStackTrace();
            return ResultGenerator.getFailResult("查询所有数据集失败：" + e.getMessage());
        }
