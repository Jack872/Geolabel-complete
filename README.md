...
<div align="center"> <img src="images/技术栈.png" alt="技术栈" width="80%"> </div>
...
平台提供用户友好的在线模型训练服务，支持用户基于平台内高质量标注数据，通过图形化界面选择模型架构（
UNet\DeepLabv3+\FastSCNN）、配置超参数并发起训练任务，后端应能自动化调度数据预处理和计算资源，并提供训练过程的可视化监控。
